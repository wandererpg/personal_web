...
test('normalizePost accepts ISO timestamps generated by JavaScript Date', () => {
  const post = normalizePost({
    ...posts[0],
    slug: 'with-milliseconds',
    createdAt: '2026-09-06T06:59:23.188Z',
    updatedAt: '2026-09-06T06:59:50.779Z',
    publishedAt: '2026-09-06T06:59:50.779Z',
    content: 'posts/with-milliseconds.md'
  });
  assert.equal(post.slug, 'with-milliseconds');
});
